...
def main():
    # Load the logo
    logo_path = "logo.png"  # Replace with your uploaded logo file path
    ...
    <div class="custom-header"> 
        ...
        <div class="page-title-container"> 
            <h1 class="page-title">Resume Formatter- CL(V12)</h1> 
        </div> 
    ...
    with st.sidebar:
        ...
        st.markdown("""
            ...
            9. If you encounter any issues, please [upload the resume here](https://cirruslabsio-my.sharepoint.com/:f:/g/personal/mukund_hs_cirruslabs_io/EupXiGkB1dVGn_G6QAORzYoBJ26muiIYDPmviX8KLiGdwA?e=DHQPRC) 
            for assistance. 
